...
public class ProblemController extends BaseController {
    ...
    public Result findAll() {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", problemService.findAll());
    }
    ...
    public Result findById(@PathVariable String id) {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", problemService.findById(id));
    }
    ...
    public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", new PageResult<Problem>(pageList.getTotalElements(), pageList.getContent()));
    }
    ...
    public Result findSearch(@RequestBody Map searchMap) {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", problemService.findSearch(searchMap));
    }
