package com.jbb.recruit.service;

import com.jbb.recruit.dao.EnterpriseDao;
...
public class EnterpriseService extends BaseService {
    ...
    public List<Enterprise> hostList(String ishot) {
        Optional<String> optional = Optional.of(ishot);
        return enterpriseDao.findByIshot(optional.orElseGet(() -> "1"));
    }
}
