...
import com.jbb.article.service.ChannelService;
...
public class ChannelController extends BaseController {
    ...
    public Result findAll() {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", channelService.findAll());
    }
    ...
    public Result findById(@PathVariable String id) {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", channelService.findById(id));
    }
    ...
    public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", new PageResult<Channel>(pageList.getTotalElements(), pageList.getContent()));
    }
    ...
    public Result findSearch(@RequestBody Map searchMap) {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", channelService.findSearch(searchMap));
    }
