package com.jbb.spit.controller;

import baseenum.StatusEnum;
import com.jbb.spit.pojo.Spit;
import com.jbb.spit.service.SpitService;
...
public class SpitController extends BaseController {
    ...
    public Result findAll() {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", spitService.findAll());
    }
    ...
    public Result findOne(@PathVariable String id) {
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", spitService.findById(id));
    }
    ...
    public Result findByParentid(@PathVariable String parentId, @PathVariable int page, @PathVariable int size) {
        ...
        return new Result(true, StatusEnum.SUCCESS.getCode(), "查询成功", new
    ...
    public Result updateThumbup(@PathVariable String id) {
        ...
        if (redisTemplate.opsForValue().get("thumbup_" + userid + "_" +
                id) != null) {
            return new Result(false, StatusEnum.REERROR.getCode(), "你已经点过赞了");
        }
